...
1.1, 1.2, the experimental 1.3 Canvas-probe minor, API 1.4 I4 drawing and API
1.5 bounded Canvas BMP transfer are accepted; a newer minor is rejected instead
of guessed.
